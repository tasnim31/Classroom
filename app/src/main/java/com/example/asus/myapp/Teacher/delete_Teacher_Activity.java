...
public class delete_Teacher_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete__teacher_);
        ...
        final DatabaseReference mdata = FirebaseDatabase.getInstance().getReference().child("Classroom");
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(delete_Teacher_Activity.this, "User account deleted.", Toast.LENGTH_SHORT).show();                                }
                            }
                        });
                Intent intent=new Intent(delete_Teacher_Activity.this,MainActivity.class);
        ...
        can.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(delete_Teacher_Activity.this,Update_Teacher_Activity.class);
                startActivity(intent);
            }
        });
    }
